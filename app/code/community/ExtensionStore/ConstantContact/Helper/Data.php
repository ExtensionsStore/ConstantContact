...
class ExtensionsStore_ConstantContact_Helper_Data extends Mage_Core_Helper_Abstract
{
    public function getEnabled()
    {
        $enabled = Mage::getStoreConfig('extensions_store_constantcontact/configuration/enabled');
    ...
    {
        $key = Mage::getStoreConfig('extensions_store_constantcontact/configuration/key');
    ...
    {
        $token = Mage::getStoreConfig('extensions_store_constantcontact/configuration/token');
    ...
    {
        $rateLimitPerDay = Mage::getStoreConfig('extensions_store_constantcontact/configuration/rate_limit_per_day');
    ...
    {
        $sendNewsletters = (int)Mage::getStoreConfig('extensions_store_constantcontact/configuration/send_newsletters');
    ...
    {
        $generalListId = Mage::getStoreConfig('extensions_store_constantcontact/configuration/list');
    ...
    {
        $selectedLists = Mage::getStoreConfig('extensions_store_constantcontact/configuration/lists');
    ...
    /**
     *
     * @return ExtensionsStore_ConstantContact_Model_Config
     */
    public function getCurrentTransactionsConfig()
    {
        $currentTransactionsConfig = Mage::getModel('extensions_store_constantcontact/config');
