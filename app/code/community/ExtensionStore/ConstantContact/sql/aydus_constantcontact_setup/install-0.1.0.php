...
try {
    ...
    $this->run("CREATE TABLE IF NOT EXISTS {$this->getTable('extensions_store_constantcontact_subscriber_contact')} (
    ...
    $this->run("CREATE TABLE IF NOT EXISTS {$this->getTable('extensions_store_constantcontact_customer_list')} (
    `id` INT(11) NOT NULL AUTO_INCREMENT,
    ...
    $this->run("CREATE TABLE IF NOT EXISTS {$this->getTable('extensions_store_constantcontact_config')} (
    `id` INT(11) NOT NULL AUTO_INCREMENT,
    ...
    $insertSql = "INSERT IGNORE INTO {$this->getTable('extensions_store_constantcontact_config')} 
